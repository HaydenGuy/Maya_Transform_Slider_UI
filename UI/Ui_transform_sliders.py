...
class Ui_transform_sliders(object):
    def setupUi(self, transform_sliders):
        ...
        self.value_translateX = QLabel(self.centralwidget)
        self.value_translateX.setObjectName(u"value_translateX")
        self.value_translateX.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_translateX, 0, 1, 1, 1)

        self.value_translateY = QLabel(self.centralwidget)
        self.value_translateY.setObjectName(u"value_translateY")
        self.value_translateY.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_translateY, 1, 1, 1, 1)

        self.value_translateZ = QLabel(self.centralwidget)
        self.value_translateZ.setObjectName(u"value_translateZ")
        self.value_translateZ.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_translateZ, 2, 1, 1, 1)

        self.value_rotateX = QLabel(self.centralwidget)
        self.value_rotateX.setObjectName(u"value_rotateX")
        self.value_rotateX.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_rotateX, 3, 1, 1, 1)

        self.value_rotateY = QLabel(self.centralwidget)
        self.value_rotateY.setObjectName(u"value_rotateY")
        self.value_rotateY.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_rotateY, 4, 1, 1, 1)

        self.value_rotateZ = QLabel(self.centralwidget)
        self.value_rotateZ.setObjectName(u"value_rotateZ")
        self.value_rotateZ.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_rotateZ, 5, 1, 1, 1)

        self.value_scaleX = QLabel(self.centralwidget)
        self.value_scaleX.setObjectName(u"value_scaleX")
        self.value_scaleX.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_scaleX, 6, 1, 1, 1)

        self.value_scaleY = QLabel(self.centralwidget)
        self.value_scaleY.setObjectName(u"value_scaleY")
        self.value_scaleY.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_scaleY, 7, 1, 1, 1)

        self.value_scaleZ = QLabel(self.centralwidget)
        self.value_scaleZ.setObjectName(u"value_scaleZ")
        self.value_scaleZ.setStyleSheet(u"")
        self.value_scaleZ.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_scaleZ, 8, 1, 1, 1)

        self.value_visibility = QLabel(self.centralwidget)
        self.value_visibility.setObjectName(u"value_visibility")
        self.value_visibility.setFrameShape(QFrame.NoFrame)

        self.gridLayout.addWidget(self.value_visibility, 9, 1, 1, 1)
    ...
    def retranslateUi(self, transform_sliders):
        ...
        self.value_translateX.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_translateY.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_translateZ.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_rotateX.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_rotateY.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_rotateZ.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_scaleX.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_scaleY.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_scaleZ.setText(QCoreApplication.translate("transform_sliders", u"100", None))
        self.value_visibility.setText(QCoreApplication.translate("transform_sliders", u"100", None))
    # retranslateUi
